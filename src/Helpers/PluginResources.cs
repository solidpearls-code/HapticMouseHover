namespace Loupedeck.HapticMouseHoverPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HapticMouseHoverPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HapticMouseHoverPlugin.Resources.Resource.txt`.
